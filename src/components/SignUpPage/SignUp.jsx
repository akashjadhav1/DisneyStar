              ...
              <form className="space-y-4 md:space-y-6 bg-blue-200" action="#">
                <div className="bg-blue-200">
                  ...
                  <input
                    ...
                    className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500"
